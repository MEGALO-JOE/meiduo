# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2019-04-14 13:20
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('users', '0005_auto_20190412_1427'),
        migrations.swappable_dependency(settings.AUTH_USER_MODEL),
        ('goods', '0003_auto_20190412_1427'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('update_time', models.DateTimeField(auto_now=True, verbose_name='修改时间')),
                ('order_id', models.IntegerField(max_length=64, primary_key=True, serialize=False, verbose_name='订单信息')),
                ('total_count', models.IntegerField(default=1, verbose_name='商品总数')),
                ('total_amount', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='商品金额')),
                ...
                ('address', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='users.Address', verbose_name='订单地址')),
