...
class OrderInfo(BaseModel):
    ...
    order_id = models.CharField(max_length=64,verbose_name="订单信息",primary_key=True)
    user = models.ForeignKey(User,on_delete=models.PROTECT,verbose_name="下单用户")
    address = models.ForeignKey(Address,on_delete=models.PROTECT,verbose_name="订单地址")
